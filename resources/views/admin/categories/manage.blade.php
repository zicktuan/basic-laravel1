...
@section('js')
    ...
    <script src="{{asset('public/backend/admins/category/js/manage.js')}}"></script>
@endsection
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($data['items'] as $item)
                        <tr>
                            ...
                            {{--</td>--}}
                            <td>
                                <a href="{{route('category.edit', ['id' => $item['id']])}}" class="active">
                                    <i class="fa fa-pencil-square-o text-success text-active"></i>
                                </a>
                                <a href="" data-url="{{route('cat-api.delete', ['id' => $item['id']])}}" class="active btn-action-del-js">
